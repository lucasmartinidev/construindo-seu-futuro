...
describe("PATCH /api/v1/users/[username]", () => {
  ...
  describe("Usuário padrão", () => {
    ...
    test("Com `email` duplicado", async () => {
      await orchestrator.createUser({
        email: "email1@construindoseufuturo.com.br",
      });

      const createdUser2 = await orchestrator.createUser({
        email: "email2@construindoseufuturo.com.br",
      });
    ...
    test("Com `email` único", async () => {
      ...
      const response = await fetch(
...

        {
          ...
          body: JSON.stringify({
            email: "uniqueEmail2@construindoseufuturo.com.br",
          }),
        },
      );
      ...
      expect(userInDatabase.email).toBe("uniqueEmail2@construindoseufuturo.com.br");
    });
