  ...
  describe("Usuário anônimo", () => {
    test("Com dados únicos e válidos", async () => {
      const response = await fetch(`${webserver.origin}/api/v1/users`, {
        ...
        body: JSON.stringify({
          username: "maverick",
          email: "contato@construindoseufuturo.com.br",
          password: "senha123",
        }),
      });
    ...
    test("Com `email` duplicado", async () => {
      const response1 = await fetch(`${webserver.origin}/api/v1/users`, {
        ...
        body: JSON.stringify({
          ...
          email: "duplicado@construindoseufuturo.com.br",
          password: "senha123",
        }),
      });
    ...
    test("Com `username` duplicado", async () => {
      const response1 = await fetch(`${webserver.origin}/api/v1/users`, {
        ...
        body: JSON.stringify({
          ...
          email: "usernameduplicado1@construindoseufuturo.com.br",
          password: "senha123",
        }),
      });
      ...
      const response2 = await fetch(`${webserver.origin}/api/v1/users`, {
        ...
        body: JSON.stringify({
          username: "UsernameDuplicado",
          email: "usernameduplicado2@construindoseufuturo.com.br",
          password: "senha123",
        }),
      });
    ...
    test("Com dados únicos e válidos", async () => {
      ...
      const user2Response = await fetch(`${webserver.origin}/api/v1/users`, {
        ...
        body: JSON.stringify({
          ...
          email: "usuariologado@construindoseufuturo.com.br",
          password: "senha123",
        }),
      });
